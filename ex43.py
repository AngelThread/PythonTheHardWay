...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "shoot":
			...
			print "Lucky for you made you learn Gothon insults in th academy"
...
class LaserWeaponArmory(Scene):
	...
	def enter(self):
		...
		if guess == code:
			...
			print "You grab the neutron bomnb and run as fast as you can to the bridge"
